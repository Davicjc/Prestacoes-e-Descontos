...
def Bcalculo():
    ...
    davi_label.place(x=147, y=225)
    verbotb_label.place(x=0, y=225)
...
def Wcalculo():
    ...
    # explicaçao do programa
    explicaçao_label = tk.Label(
        janela, text="Este programa calcula o valor de cada prestação e o valor com desconto", fg="black", bg="white")
    explicaçao_label.pack()
    ...
    # pegar o valor do desconto
    desconto_label = tk.Label(
        janela, text="Digite o desconto:", fg="black", bg="white")
    desconto_label.pack()
